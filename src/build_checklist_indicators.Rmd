...
One of the TrIAS goals is to unify seven authoritative checklists. Such unified checklist, public on GBIF (Global Biodiversity Information Facility) will be the start point of this workflow. At the moment, we don't have such checklist. For the moment, the analysis is based on the data of the following checklists:
