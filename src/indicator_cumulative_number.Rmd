...
indicator_total_year <- function(df, start_year_plot = 1940, 
  ...
  if (is.null(facet_column)) {
    df_cleaned <- df %>%
      distinct_("speciesKey", "first_observed", "last_observed")
  } else {
    ...
    df_cleaned <- df %>%
      distinct_("speciesKey", "first_observed", "last_observed", facet_column)
  }
  ...
  if (nrow(filter(df, !is.na(first_observed))) > 0) {
    warning(paste("Some records have a first_observed,",
                  "but last_observed is not defined,",
