...
We define the function `is_appearing` for appearing/reappearing detection (this function will be part of TrIAS package this workflow will be positively reviewed):
...
We merge appearing taxa from all Belgium and from protected areas. We arrange taxa by area of occupancy in protected areas and in all Belgium as first and second level respectively. We do the same for reappearing taxa as well:
