...
This document follows the [modelling pipeline](https://trias-project.github.io/indicators/occurrence_indicators_modelling.html) to produce a list of introduced species ranked by emerging status.
