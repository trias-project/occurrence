...
em_decision_rules_occs_BE <- map_dfr(
  evaluation_years,
  ~ apply_decision_rules(df = df_ts_compact,
                         y_var= "obs",
                         eval_year = .)
)
```
...
em_decision_rules_occs_pa <- map_dfr(
  evaluation_years,
  ~ apply_decision_rules(df = df_ts_compact_prot_areas,
                         y_var = "obs",
                         eval_year = .)
)
```
...
write_tsv(map_dfr(gam_occs_BE, function(x) {x$output}),
          ...
          path = here("data",
                      "output", 
                      "GAM_outputs",
                      paste0("outptut_GAM_observations_belgium_",
                             method_em, ".tsv")))
...
write_tsv(map_dfr(gam_occs_pa, function(x) {x$output}),
          ...
          path = here("data",
                      "output", 
                      "GAM_outputs",
                      paste0("outptut_GAM_observations_pa_",
                             method_em, ".tsv")))
...
write_tsv(map_dfr(gam_occs_BE, function(x) {x$em_summary}),
          ...
          path = here("data",
                      "output", 
                      "GAM_outputs",
                      paste0("summary_GAM_observations_belgium_",
                             method_em, ".tsv")))
...
write_tsv(map_dfr(gam_occs_pa, function(x) {x$em_summary}),
          ...
          path = here("data",
                      "output", 
                      "GAM_outputs",
                      paste0("summary_GAM_observations_pa_",
                             method_em, ".tsv")))
