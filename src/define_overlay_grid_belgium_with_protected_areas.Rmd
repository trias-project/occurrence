...
```{r leaflet_prot_areas_flanders, hide = TRUE}
# Transform to wgs84
...
```{r leaflet_prot_areas_wa, hide = TRUE}
...
```{r leaflet_prot_areas_br, hide = TRUE}
...
```{r leaflet_prot_areas_fed_admin, hide = TRUE} 
